...
export function GradientSpotlightCard({
  ...
  return (
    <div
      ...
      className={`group cursor-pointer ${gradientStyles[variant]} rounded-xl p-6 flex flex-col justify-between text-white relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl border border-white/10 select-none`}
    >
